                        ...
                        <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                            ...
                            <div className="flex flex-col gap-11">
                                <div className="flex flex-col gap-5 ">
                                    <h2 className="max-w-3xl">Feedback from clients</h2>
                                    <p className="max-w-2xl text-secondary/70 dark:text-white/70">Thanks to our wonderful Clients for providing us the opportunity to serve you. I really appreciate you taking the time out to share your experience</p>
                                </div>
                            </div>
                        </div>
                        <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-7">
                            <div className="bg-primary p-4 lg:p-7 flex flex-col gap-32">
                                <div className="flex flex-col gap-6">
                                    ...
                                    <div className="flex items-center gap-2.5">
                                        <StarRating count={5} color='black' />
                                        <span className="text-base text-black">5.0</span>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <Image src={"/images/testimonial/prof.jpg"} alt="Image" width={60} height={60} className="rounded-full" />
                                    <div>
                            ...
                            <div className="xl:col-span-2 bg-secondary dark:bg-lightgray/10 p-4 lg:p-7 flex flex-col justify-between gap-14">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <Image src={"/images/testimonial/about1.png"} alt="Image" width={60} height={60} className="rounded-full" />
                                        <div>
                            ...
                            <div className="bg-white dark:bg-black/20 p-4 lg:p-7 flex flex-col justify-between gap-32">
                                <div className="flex flex-col gap-6">
                                    ...
                                    <div className="flex items-center gap-2.5">
                                        <StarRating count={4.5} color='black' />
                                        <span className="text-base text-black">4.5</span>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <Image src={"/images/testimonial/prof.jpg"} alt="Image" width={60} height={60} className="rounded-full" />
