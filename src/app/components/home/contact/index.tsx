...
const Contact = (props: { contactdataNumber: string }) => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        fetch("https://formsubmit.co/ajax/umairriaz789@gmail.com", {
            method: "POST",
                    ...
                    <div className="flex flex-col xl:flex xl:flex-row gap-15 xl:gap-48">
                        <div className="max-w-md flex flex-col gap-9 md:gap-16">
                            <div className="flex flex-col gap-5 md:gap-8">
                                <p className="max-w-2xl text-secondary/70 dark:text-white/70">Interested in collaborating or integrating blockchain into your business?</p>
                                <div>
