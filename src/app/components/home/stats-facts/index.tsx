    ...
    return (
        <section className="relative bg-white dark:bg-secondary overflow-hidden">
            ...
            <div className="absolute -bottom-28 -left-20">
                <Image src={"/images/home/statsfact/io.svg"} alt="image" height={590} width={590} className="dark:hidden" />
                <Image src={"/images/home/statsfact/io.svg"} alt="image" height={590} width={590} className="hidden dark:block" />
            </div>
        </section>
    );
}
